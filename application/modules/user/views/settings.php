...
<section class="uk-section uk-section-xsmall main-section" data-uk-height-viewport="expand: true">
  <div class="uk-container">
    <div class="uk-grid uk-grid-medium uk-flex uk-flex-center uk-flex-middle" data-uk-grid> <!-- Centrando el contenido -->
      <div class="uk-width-3-4@m uk-width-1-1@s"> <!-- Asegurando que se centre correctamente en pantallas móviles -->
        <h4 class="uk-h4 uk-text-uppercase uk-text-bold uk-text-center"><?= $this->lang->line('button_account_settings'); ?></h4> <!-- Centrado del título -->
