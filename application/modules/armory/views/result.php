        ...
        <article class="uk-article">
          <div class="uk-card uk-card-default uk-card-body uk-margin-small">
            ...
            <div class="uk-margin">
              <div class="uk-form-controls uk-light">
                <div class="uk-inline uk-width-1-1">
                  <h2 class="uk-text-center"><?= $this->lang->line('armory_search_title') ?></h2>
            ...
            <?php if (empty($_GET['search'])) {
              echo "There are no recent searches";
            } else {
              echo "Last search: " . $_GET['search'];
            } ?>
          </div>
        </article>
      </div>
            ...
            <div id="Player" class="city">
              <div class="uk-overflow-auto uk-margin-small">
                <table class="uk-table dark-table uk-table-divider uk-table-small">
                  ...
                  <tbody>
                    <?php foreach ($chars as $player) : ?>
                      <tr>
                        <td class="uk-table-expand uk-text-center"><a href="<?= base_url() . 'armory/realm/'?><?= $realmId ?>/player/<?= $player->guid ?>"><?= $player->name ?></a></td>
        ...
        if (response) {
          $.amaran({
            ...
            'content': {
              ...
              message: '<?= $this->lang->line('notification_search_successful'); ?>',
              info: '',
