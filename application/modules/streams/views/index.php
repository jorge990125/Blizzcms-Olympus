...
<div class="uk-card uk-card-default uk-card-body uk-margin-small">
    <?php 
        $channel = !empty($_POST['channel']) ? htmlspecialchars($_POST['channel']) : "jorge990125";
        echo "<p>Canal Seleccionado: <strong>$channel</strong></p>";
    ?>

    <!-- IFRAME DEL STREAM -->
    <iframe 
        src="https://player.kick.com/<?php echo $channel; ?>"
        height="492"
        width="100%"
        frameborder="0"
        scrolling="no"
    ...
    <!-- IFRAME DEL CHAT -->
    <iframe 
        src="https://kick.com/<?php echo $channel; ?>/chat"
        height="300"
        width="100%"
        frameborder="0"
        scrolling="no">
